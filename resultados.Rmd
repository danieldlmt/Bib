...
########   
  ...
  abline(z,col="orange")
   ...
   print (  g + geom_histogram(aes(fill=nivel),col="black", size=.1) )
...
legend("topright", legend=c("médio", "muito"),col=c("black", "green"),lty=1,inset = 0.02)
  ...
  plot (dev_all_time24_new_genmedio$iteracao,dev_all_time24_new_genmedio$n,type="l", col="blue",xlab = "Tempo (semanas)", ylab = "Qtd. de desenvolvedores")
lines(dev_all_time24_new_genmuito$iteracao,dev_all_time24_new_genmuito$n, col="green")
  ...
  abline(z,col="orange")
       ...
       print ( g + geom_histogram(aes(fill=nivel3),col="black", size=.1) )
